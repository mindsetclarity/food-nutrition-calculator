...
import 'piccolore';
import { m as maybeRenderHead, h as addAttribute, s as spreadAttributes, p as renderSlot, k as renderTemplate, o as renderComponent } from './entrypoint_D0oTHkUW.mjs';
import { $ as $$SiteLayout } from './SiteLayout_YHvHq5NO.mjs';
import { $ as $$Button, r as renderScript } from './SeoHead_Bz2tiSQZ.mjs';
import 'clsx';
import { $ as $$FoodChip } from './FoodChip_C92egjFK.mjs';
import { c as buildWebSiteSchema, d as buildOrganizationSchema } from './schema_D8-JCEV_.mjs';
...
}, "C:/foodnutritioncalculator.com/src/components/ui/Badge.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/ui/SourceBadge.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/ui/MacroRing.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/HomeNutritionPreview.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/HomeHero.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/VegetarianIntelligence.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/ui/SourceTruthRail.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/SourceTruthHierarchy.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/RecipeWorkflow.astro", void 0);
...
Start a Meal Plan
` })} </div> </div> </div> </section>`;
}, "C:/foodnutritioncalculator.com/src/components/home/MealDashboardPreview.astro", void 0);
...
Compare Any Foods
` })} </div> </div> </div> </section>`;
}, "C:/foodnutritioncalculator.com/src/components/home/CompareFoodsPreview.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/NutritionLabelPreview.astro", void 0);
...
}, "C:/foodnutritioncalculator.com/src/components/home/LearnTrustSection.astro", void 0);

const $$HomeCTA = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="py-32 bg-ink-navy relative overflow-hidden text-center border-t border-deep-slate"> <!-- Subtle Glow --> <div class="absolute inset-0 bg-[radial-gradient(var(--color-usda-emerald)_1px,transparent_1px)] [background-size:40px_40px] opacity-10"></div> <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-usda-emerald rounded-full blur-[150px] opacity-20 pointer-events-none"></div> <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 reveal-hidden" data-reveal> <h2 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6">
Start with one food.
</h2> <p class="text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed">
Search a food, build a meal, or paste a recipe. Every result stays source-labeled and reviewable.
</p> <div class="flex flex-col sm:flex-row justify-center gap-4 mb-16"> ${renderComponent($$result, "Button", $$Button, { "href": "/calculator", "variant": "primary", "size": "lg", "class": "bg-usda-emerald hover:bg-fresh-leaf text-white shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] border-transparent" }, { "default": ($$result2) => renderTemplate`
Start Calculating
` })} ${renderComponent($$result, "Button", $$Button, { "href": "/recipe-nutrition-calculator", "variant": "secondary", "size": "lg", "class": "bg-deep-slate text-white border-slate-600 hover:bg-slate-700 hover:border-slate-500 hover:text-white" }, { "default": ($$result2) => renderTemplate`
Analyze a Recipe
` })} ${renderComponent($$result, "Button", $$Button, { "href": "/foods", "variant": "secondary", "size": "lg", "class": "bg-transparent text-slate-300 border-transparent hover:bg-white/5 hover:text-white shadow-none" }, { "default": ($$result2) => renderTemplate`
Browse Foods
` })} </div> <!-- Floating Veg Chips around CTA --> <div class="relative w-full h-12 max-w-lg mx-auto pointer-events-none hidden sm:block"> <div class="absolute -left-12 -top-24 transform -rotate-12 opacity-80"> ${renderComponent($$result, "FoodChip", $$FoodChip, { "icon": "🥑", "label": "avocado", "class": "bg-white text-ink-navy" })} </div> <div class="absolute left-1/4 10 transform rotate-6 opacity-80"> ${renderComponent($$result, "FoodChip", $$FoodChip, { "icon": "🌾", "label": "oats", "class": "bg-white text-ink-navy" })} </div> <div class="absolute right-1/4 -top-16 transform -rotate-6 opacity-80"> ${renderComponent($$result, "FoodChip", $$FoodChip, { "icon": "🍌", "label": "banana", "class": "bg-white text-ink-navy" })} </div> <div class="absolute -right-8 4 transform rotate-12 opacity-80"> ${renderComponent($$result, "FoodChip", $$FoodChip, { "icon": "🥣", "label": "yogurt", "class": "bg-white text-ink-navy" })} </div> </div> </div> </section>`;
}, "C:/foodnutritioncalculator.com/src/components/home/HomeCTA.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  const seo = {
    title: "Food Nutrition Calculator | Calories, Macros & Nutrition Facts",
    description: "Calculate food calories, macros, recipe nutrition, meal totals, and food comparisons with USDA-first data and transparent source labels."
  };
  const jsonLd = [buildWebSiteSchema(), buildOrganizationSchema()];
  return renderTemplate`${renderComponent($$result, "SiteLayout", $$SiteLayout, { "title": seo.title, "description": seo.description, "jsonLd": jsonLd }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HomeHero", $$HomeHero, {})} ${renderComponent($$result2, "HomeToolsGrid", $$HomeToolsGrid, {})} ${renderComponent($$result2, "VegetarianIntelligence", $$VegetarianIntelligence, {})} ${renderComponent($$result2, "SourceTruthHierarchy", $$SourceTruthHierarchy, {})} ${renderComponent($$result2, "RecipeWorkflow", $$RecipeWorkflow, {})} ${renderComponent($$result2, "MealDashboardPreview", $$MealDashboardPreview, {})} ${renderComponent($$result2, "CompareFoodsPreview", $$CompareFoodsPreview, {})} ${renderComponent($$result2, "NutritionLabelPreview", $$NutritionLabelPreview, {})} ${renderComponent($$result2, "LearnTrustSection", $$LearnTrustSection, {})} ${renderComponent($$result2, "HomeCTA", $$HomeCTA, {})} ` })}`;
}, "C:/foodnutritioncalculator.com/src/pages/index.astro", void 0);

const $$file = "C:/foodnutritioncalculator.com/src/pages/index.astro";
const $$url = "";
