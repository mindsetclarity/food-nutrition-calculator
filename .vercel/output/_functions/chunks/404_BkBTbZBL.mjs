...
import 'piccolore';
import { o as renderComponent, k as renderTemplate, m as maybeRenderHead, h as addAttribute } from './entrypoint_D0oTHkUW.mjs';
import { $ as $$Layout } from './Layout_CX0YPltK.mjs';
...
const $$404 = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Page Not Found | Food Nutrition Calculator", "description": "The page you're looking for may have moved, or the food/article link may not exist.", "noindex": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main id="main-content" class="min-h-[70vh] flex flex-col justify-center bg-gray-50/50 py-24"> <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center"> <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-amber-100 text-amber-600 mb-8"> <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> </div> <h1 class="text-4xl sm:text-5xl font-black text-gray-900 tracking-tight mb-6">Page not found</h1> <p class="text-xl text-gray-600 max-w-2xl mx-auto mb-12">
...
Back to Homepage
` })} </div> </div> </main> ` })}`;
}, "C:/foodnutritioncalculator.com/src/pages/404.astro", void 0);

const $$file = "C:/foodnutritioncalculator.com/src/pages/404.astro";
const $$url = "/404";
