...
All
</button> ${categories.map((cat) => renderTemplate`<button type="button" class="category-filter-btn bg-slate-100 text-soft-slate hover:text-ink-navy hover:bg-slate-200 px-5 py-2 rounded-[var(--radius-button)] text-[11px] font-bold uppercase tracking-widest transition-colors"${addAttribute(cat.toLowerCase(), "data-category")}> ${cat} </button>`)} </div> </div> ${renderScript($$result, "C:/fnc/src/components/foods/FoodCategoryGrid.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/fnc/src/components/foods/FoodCategoryGrid.astro", void 0);
...
}, "C:/fnc/src/components/foods/FoodCard.astro", void 0);
...
}, "C:/fnc/src/components/foods/FoodEmptyState.astro", void 0);
...
}, "C:/fnc/src/components/foods/FoodsDirectoryShell.astro", void 0);
...
}, "C:/fnc/src/pages/foods/index.astro", void 0);

const $$file = "C:/fnc/src/pages/foods/index.astro";
const $$url = "/foods";
